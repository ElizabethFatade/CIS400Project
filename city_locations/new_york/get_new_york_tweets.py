...
for tweet in retweets:
    ...
    if (str(tweet.get('user', {}).get('location', {}))) == q or (str(tweet.get('user', {}).get('location', {}))) == "Bronx, NY" or (str(tweet.get('user', {}).get('location', {}))) == "Brooklyn, NY" or (str(tweet.get('user', {}).get('location', {}))) == "Queens, NY" or (str(tweet.get('user', {}).get('location', {}))) == "Manhattan, NY":
        localRT = localRT + 1
